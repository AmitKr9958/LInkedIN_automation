...
async def test_people_search_dedupes_duplicate_profiles():
    cards = [
        _FakeCard("Priya Rao recruiter", name="Priya Rao", headline="Recruiter", href="https://www.linkedin.com/in/priya"),
        _FakeCard("Priya Rao recruiter", name="Priya Rao", headline="Recruiter", href="https://www.linkedin.com/in/priya"),
        _FakeCard("Rahul BI", name="Rahul", headline="BI Developer", href="https://www.linkedin.com/in/rahul"),
    ]
...
async def test_posts_search_dedupes_duplicate_posts():
    cards = [
        _FakeCard("Power BI tips", name="Priya", href="https://www.linkedin.com/feed/update/urn:li:activity:1"),
        _FakeCard("Power BI tips", name="Priya", href="https://www.linkedin.com/feed/update/urn:li:activity:1"),
        _FakeCard("Another post", name="Rahul", href="https://www.linkedin.com/feed/update/urn:li:activity:2"),
    ]
